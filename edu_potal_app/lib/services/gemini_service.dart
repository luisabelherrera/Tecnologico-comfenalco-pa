...
class GeminiService {
  static const String _apiKey = 'AIzaSyB9HNN9nYfHK07TlZiCjMG-qVXZ2u70Rxc'; // Hardcoded temporalmente como solicitó el Frontend Original
      ...
      if (response.statusCode == 200) {
        ...
        if (data['candidates'] != null && data['candidates'].isNotEmpty) {
          ...
          if (content != null && content['parts'] != null && content['parts'].isNotEmpty) {
             return content['parts'][0]['text'] ?? "Lo siento, no pude procesar la respuesta.";
          }
        }
